                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    ...
                    @foreach ($musicos as $musico)
                        <tr class="text-gray-700 dark:text-gray-400">
                            <td class="px-3 py-2">{{ $musico->nome }}</td>
                            <td class="px-3 py-2">{{ $musico->email }}</td>
                            <td class="px-3 py-2">{{ $musico->frequencia }}</td>
                            <td class="px-3 py-2">{{ $musico->dataRegistro }}</td>
                            <td class="px-3 py-2">
                                <div class="flex items-center space-x-2 text-sm">
                                    <a href="{{ url('musicos/' . $musico->id) }}">
                                        <button
                                    ...
                                    <a href="{{ url('musicos/' . $musico->id . '/edit') }}">
                                        <button
                                            class="flex items-center justify-center px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                            aria-label="Edit">
